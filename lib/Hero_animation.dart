      ...
      body: Column(
        children: [
          TweenAnimationBuilder(tween: Tween<double>(begin: 0, end:1),
            ...
            return Opacity(opacity: value,child: Image.network("https://images.pexels.com/photos/674010/pexels-photo-674010.jpeg?cs=srgb&dl=pexels-anjana-c-674010.jpg&fm=jpg"),);
              }),
